import jus from "../../assets/Spa/beddSpa.jpg";
import wiski from "../../assets/Spa/detendSpa.jpg";
import coctails from "../../assets/Spa/iogaSpa.jpg";
import SpaSpace from "../../assets/Spa/beachSpa.jpg";
import restoLoungBar from "../../assets/Logo/SPALogo.png";
          ...
          <div className="relative p-8 bg-amber-50 flex-1 min-h-[300px] lg:min-h-full">
            <div className="h-full flex flex-col justify-center">
              <h1 className="text-3xl max-sm:text-2xl max-sm:text-center font-bold text-amber-800 mb-4">
                Espace Détente – N & T Hotel
              </h1>
              <p className="text-lg max-sm:text-sm max-sm:text-center leading-relaxed text-gray-700">
                Un lieu conçu pour votre bien-être, où sérénité et confort
                s’unissent. Laissez-vous aller dans notre cadre apaisant à deux
                pas de la plage. Profitez de notre salle de fitness, de notre
                hammam, de notre sauna ainsi que de nos cabines de massage, pour
                une expérience de relaxation complète. Ouvert tous les jours de
                9h00 à 20h00.
              </p>
            </div>
          </div>
          ...
          <div className="max-lg:grid grid-cols-2 max-sm:grid-cols-1">
            ...
            <div className="bg-amber-50 min-h-[400px] max-lg:h-140 max-sm:h-100 p-5 flex flex-col justify-center">
              <h1 className="text-3xl max-sm:text-2xl font-bold max-sm:text-center text-amber-800 mb-4">
                Notre programme – N & T Hotel
              </h1>
              <p className="text-lg max-sm:text-sm max-sm:text-center leading-relaxed text-gray-700 ">
                Laissez-vous guider vers le massage qui répond le mieux à vos
                besoins. Nos praticiennes expertes seront ravies de vous
                accompagner et de vous conseiller pour vous aider à mieux
                comprendre votre corps. Dès votre arrivée au N & T Hotel,
                rendez-vous à notre espace bien-être pour découvrir un univers
                de détente à deux pas de la plage.
              </p>
            </div>
          </div>
          {/* Centre */}
