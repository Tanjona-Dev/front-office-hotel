...
function DisplayReservationSection() {
  return (
    <div className="flex mx-75 relative h-auto mb-5 max-lg:flex-col max-lg:absolute max-lg:mx-0 max-lg:top-650">
      <div className="flex flex-col items-center justify-center gap-6 w-150 bg-gradient-to-r from-white to-amber-50 max-lg:w-auto">
        ...
        <Link
          to={`/reservation`}
          className="bg-green-500 px-5 py-1 rounded-xl shadow-xl text-white cursor-pointer hover:scale-x-105 transition-all"
        >
          RESERVER
        </Link>
      </div>
      <div className="w-1/2 bg-amber-50 py-2 flex justify-center max-lg:w-auto">
...
function DisplayTypeOfRoom({ setIndexHover, indexHover, setRoomType }) {
  ...
  return (
    <div id="type" className="mt-10 max-lg:flex max-lg:flex-col">
        ...
        {typeOfRoom.map((room, index) => {
          return (
            ...
            >
              ...
              <div className="min-xl:hidden max-lg:block bg-green-500 px-5 rounded text-white">
    ...
    <div>
      <div className="relative h-screen w-full overflow-x-hidden shadow-xl shadow-amber-50">
        ...
        <div className="relative">
          <div className="absolute top-59 left-5 text-black z-10 max-lg:hidden">
            <BreadCrumbs crumbs={crumbs} />
          </div>
          <h1 className="absolute shadow-5xl top-[22vh] left-0 right-0 text-4xl text-black/70 text-center bg-amber-50 py-5 max-lg:text-xl">
            NOS CHAMBRES
          </h1>
        </div>
        ...
        <div className="absolute top-[35vh] left-0 right-0 flex justify-center max-lg:flex-wrap  shadow-5xl">
          <div className="w-full max-w-6xl flex max-lg:flex-col max-lg:items-center max-lg:gap-8">
            <div className="w-1/2 max-lg:w-full p-6 bg-amber-50 flex flex-col justify-center gap-8">
              <h1 className="text-2xl font-bold text-center max-lg:text-xl ">DESCRIPTION</h1>
              ...
              <a
                href="#type"
                className="text-black border bg-amber-100 rounded-full py-2 hover:scale-y-105 cursor-pointer hover:bg-amber-200 hover:shadow transition-all text-center"
              >
                <button>DECOUVRIR NOS TYPES DE CHAMBRES</button>
              </a>
            </div>

            <div className=" max-lg:w-full w-180 flex justify-center items-center bg-amber-50 p-6 max-lg:hidden">
              <img
                src="chambre1.jpeg"
                alt="Chambre d'hôtel"
      ...
      <div className="mt-20 w-full absolute max-lg:top-755 ">
